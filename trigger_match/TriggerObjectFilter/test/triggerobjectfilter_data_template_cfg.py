...
mylist=FileUtils.loadListFromFile('/afs/cern.ch/user/m/mshi/2mu_trigger_match/CMSSW_7_4_1_patch1/src/sourceFiles.txt')
...
process.p = cms.Path(process.EightTauMu)
